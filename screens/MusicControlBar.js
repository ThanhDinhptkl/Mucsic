...
export default function PlaylistsDetails() {
      ...
      [
        {
          ...
          onPress: () => console.log(`Đã thêm ${songTitle} vào yêu thích`),
        },
        {
          text: "Chia sẻ",
          onPress: () => console.log(`Đã chia sẻ ${songTitle}`),
        },
        {
          text: "Xóa khỏi danh sách phát",
          onPress: () => console.log(`Đã xóa ${songTitle} khỏi danh sách phát`),
          style: "destructive",
        },
  ...
  const handlePrevious = () => {
    ...
    if (currentIndex > 0) {
      ...
      console.log("Đã đến bài đầu tiên");
    }
  };
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.cungDong}>
          ...
          <TouchableOpacity style={styles.moreButton}>
            <Ellipsis
              style={styles.icon}
              onPress={() => showMoreOptions(item.title)}
            />
          </TouchableOpacity>
          <TouchableOpacity style={styles.moreButton}>
          ...
          {sampleSongs.map((song, index) => (
            ...
            >
              ...
              <TouchableOpacity
                ...
                onPress={() => showMoreOptions(song.title)}
              >
